...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
I2CShiftRegBranch::I2CShiftRegBranch(char id,char local,char sz)
	:serverId(id),portBranch(local,sz) {
		Wire.begin();
	}
...
void I2CShiftRegBranch::out() {
  ...
  //memory address modes not available on target processor... 
  //gota be a for loop or a buffer
  //ideal granularity=3, just like openGl
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
I2CBranch::I2CBranch(char id,char local,char host,char sz):hostPort(host),I2CShiftRegBranch(id,local,sz) {
